...
// docker/cli +incompatible modules lack a go directive, so Go defaults to go1.16
// which can't compile Go 1.23+ features. Upgrade to latest v29.2.x.
require github.com/docker/cli v29.2.1+incompatible // indirect

// docker/docker v28.5.2 introduces a broken pipe when streaming build context
// via the Docker API (used by dockertest in E2E tests). Pin to v28.5.1.
replace github.com/docker/docker v28.5.2+incompatible => github.com/docker/docker v28.5.1+incompatible
...
require (
	...
	github.com/pokt-network/poktroll v0.1.32-0.20260209224009-f84cf3948970
