...
type ShannonWebsocketConnectionObservation struct {
	...
	ConnectionEstablishedTimestamp *timestamppb.Timestamp                                    `protobuf:"bytes,11,opt,name=connection_established_timestamp,json=connectionEstablishedTimestamp,proto3" json:"connection_established_timestamp,omitempty"`
	ConnectionClosedTimestamp      *timestamppb.Timestamp                                    `protobuf:"bytes,12,opt,name=connection_closed_timestamp,json=connectionClosedTimestamp,proto3,oneof" json:"connection_closed_timestamp,omitempty"`
	EventType                      ShannonWebsocketConnectionObservation_ConnectionEventType `protobuf:"varint,13,opt,name=event_type,json=eventType,proto3,enum=path.protocol.ShannonWebsocketConnectionObservation_ConnectionEventType" json:"event_type,omitempty"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
var file_path_protocol_shannon_proto_goTypes = []any{
	...
	(ShannonWebsocketConnectionObservation_ConnectionEventType)(0), // 2: path.protocol.ShannonWebsocketConnectionObservation.ConnectionEventType
...
var file_path_protocol_shannon_proto_depIdxs = []int32{
	...
	11, // 2: path.protocol.ShannonWebsocketConnectionObservation.connection_established_timestamp:type_name -> google.protobuf.Timestamp
	11, // 3: path.protocol.ShannonWebsocketConnectionObservation.connection_closed_timestamp:type_name -> google.protobuf.Timestamp
	2,  // 4: path.protocol.ShannonWebsocketConnectionObservation.event_type:type_name -> path.protocol.ShannonWebsocketConnectionObservation.ConnectionEventType
	11, // 5: path.protocol.ShannonWebsocketMessageObservation.message_timestamp:type_name -> google.protobuf.Timestamp
	1,  // 6: path.protocol.ShannonWebsocketMessageObservation.error_type:type_name -> path.protocol.ShannonEndpointErrorType
