...
import (
	protocol "github.com/pokt-network/path/observation/protocol"
	qos "github.com/pokt-network/path/observation/qos"
...
const file_path_observations_proto_rawDesc = "" +
	"\n" +
	"\x17path/observations.proto\x12\x04path\x1a\x0fpath/http.proto\x1a\x12path/gateway.proto\x1a path/protocol/observations.proto\x1a\x1bpath/qos/observations.proto\"\x96\x02\n" +
	"\x1bRequestResponseObservations\x12\x1d\n" +
	"\n" +
	"service_id\x18\x01 \x01(\tR\tserviceId\x12@\n" +
	"\fhttp_request\x18\x02 \x01(\v2\x1d.path.HTTPRequestObservationsR\vhttpRequest\x123\n" +
	"\agateway\x18\x03 \x01(\v2\x19.path.GatewayObservationsR\agateway\x127\n" +
	"\bprotocol\x18\x04 \x01(\v2\x1b.path.protocol.ObservationsR\bprotocol\x12(\n" +
	"\x03qos\x18\x05 \x01(\v2\x16.path.qos.ObservationsR\x03qosB*Z(github.com/pokt-network/path/observationb\x06proto3"

var (
	file_path_observations_proto_rawDescOnce sync.Once
	file_path_observations_proto_rawDescData []byte
)

func file_path_observations_proto_rawDescGZIP() []byte {
	file_path_observations_proto_rawDescOnce.Do(func() {
		file_path_observations_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_path_observations_proto_rawDesc), len(file_path_observations_proto_rawDesc)))
	})
...
func file_path_observations_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_path_observations_proto_rawDesc), len(file_path_observations_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
