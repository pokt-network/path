...
const file_path_gateway_proto_rawDesc = "" +
	...
	"6GATEWAY_REQUEST_ERROR_KIND_WEBSOCKET_CONNECTION_FAILED\x10\x04\x123\n" +
	"/GATEWAY_REQUEST_ERROR_KIND_UNSUPPORTED_RPC_TYPE\x10\x05\x127\n" +
	"3GATEWAY_REQUEST_ERROR_KIND_RPC_TYPE_DETECTION_ERROR\x10\x06B*Z(github.com/pokt-network/path/observationb\x06proto3"
