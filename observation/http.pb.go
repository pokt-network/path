...
func (x *HTTPRequestObservations) Reset() {
	*x = HTTPRequestObservations{}
	mi := &file_path_http_proto_msgTypes[0]
...
func (*HTTPRequestObservations) Descriptor() ([]byte, []int) {
	return file_path_http_proto_rawDescGZIP(), []int{0}
}
...
var file_path_http_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_path_http_proto_goTypes = []any{
	(*HTTPRequestObservations)(nil), // 0: path.HTTPRequestObservations
}
var file_path_http_proto_depIdxs = []int32{
...
func init() { file_path_http_proto_init() }
func file_path_http_proto_init() {
	if File_path_http_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_path_http_proto_goTypes,
		DependencyIndexes: file_path_http_proto_depIdxs,
